...
function output(){
    ...
    /*MAX*/
        ...
        /*1ノーツ分のスコア算出*/
        for(let i = 0 ; i < noteslength ; i++){
            maxsongarr[i][0] = (maxsimarr[songnotessec[i][1]-1][3]*frontarr[0][4] + maxsimarr[songnotessec[i][1]-1][7]*frontarr[1][4] + maxsimarr[songnotessec[i][1]-1][11]*frontarr[2][4] + maxsimarr[songnotessec[i][1]-1][15]*frontarr[3][4] + maxsimarr[songnotessec[i][1]-1][19]*frontarr[4][4] + maxsimarr[songnotessec[i][1]-1][23]*frontarr[0][9] + maxsimarr[songnotessec[i][1]-1][27]*frontarr[1][9] + maxsimarr[songnotessec[i][1]-1][31]*frontarr[2][9] + maxsimarr[songnotessec[i][1]-1][35]*frontarr[3][9] + maxsimarr[songnotessec[i][1]-1][39]*frontarr[4][9])/100;
            maxsongarr[i][1] = (maxsimarr[songnotessec[i][1]-1][3]*frontarr[0][3] + maxsimarr[songnotessec[i][1]-1][7]*frontarr[1][3] + maxsimarr[songnotessec[i][1]-1][11]*frontarr[2][3] + maxsimarr[songnotessec[i][1]-1][15]*frontarr[3][3] + maxsimarr[songnotessec[i][1]-1][19]*frontarr[4][3] + maxsimarr[songnotessec[i][1]-1][23]*frontarr[0][8] + maxsimarr[songnotessec[i][1]-1][27]*frontarr[1][8] + maxsimarr[songnotessec[i][1]-1][31]*frontarr[2][8] + maxsimarr[songnotessec[i][1]-1][35]*frontarr[3][8] + maxsimarr[songnotessec[i][1]-1][39]*frontarr[4][8])/100;
             if(i+1 >= FSnotes && i+1 <= FFnotes){
